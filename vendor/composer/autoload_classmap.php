...
return array(
    ...
    'Enqueue\\Test\\ClassExtensionTrait' => $vendorDir . '/enqueue/test/ClassExtensionTrait.php',
    'Enqueue\\Test\\GpsExtension' => $vendorDir . '/enqueue/test/GpsExtension.php',
    'Enqueue\\Test\\MongodbExtensionTrait' => $vendorDir . '/enqueue/test/MongodbExtensionTrait.php',
    'Enqueue\\Test\\RabbitManagementExtensionTrait' => $vendorDir . '/enqueue/test/RabbitManagementExtensionTrait.php',
    'Enqueue\\Test\\RabbitmqAmqpExtension' => $vendorDir . '/enqueue/test/RabbitmqAmqpExtension.php',
    'Enqueue\\Test\\RabbitmqStompExtension' => $vendorDir . '/enqueue/test/RabbitmqStompExtension.php',
    'Enqueue\\Test\\ReadAttributeTrait' => $vendorDir . '/enqueue/test/ReadAttributeTrait.php',
    'Enqueue\\Test\\RedisExtension' => $vendorDir . '/enqueue/test/RedisExtension.php',
    'Enqueue\\Test\\RetryTrait' => $vendorDir . '/enqueue/test/RetryTrait.php',
    'Enqueue\\Test\\SnsExtension' => $vendorDir . '/enqueue/test/SnsExtension.php',
    'Enqueue\\Test\\SnsQsExtension' => $vendorDir . '/enqueue/test/SnsQsExtension.php',
    'Enqueue\\Test\\SqsExtension' => $vendorDir . '/enqueue/test/SqsExtension.php',
    'Enqueue\\Test\\TestLogger' => $vendorDir . '/enqueue/test/TestLogger.php',
    'Enqueue\\Test\\WampExtension' => $vendorDir . '/enqueue/test/WampExtension.php',
    'Enqueue\\Test\\WriteAttributeTrait' => $vendorDir . '/enqueue/test/WriteAttributeTrait.php',
    ...
    'Interop\\Queue\\Spec\\Amqp\\SendAndReceiveTimestampAsIntegerSpec' => $vendorDir . '/queue-interop/queue-spec/src/Amqp/SendAndReceiveTimestampAsIntegerSpec.php',
    'Interop\\Queue\\Spec\\Amqp\\SubscriptionConsumerAddConsumerTagOnSubscribeSpec' => $vendorDir . '/queue-interop/queue-spec/src/Amqp/SubscriptionConsumerAddConsumerTagOnSubscribeSpec.php',
    'Interop\\Queue\\Spec\\Amqp\\SubscriptionConsumerPreFetchCountSpec' => $vendorDir . '/queue-interop/queue-spec/src/Amqp/SubscriptionConsumerPreFetchCountSpec.php',
    'Interop\\Queue\\Spec\\Amqp\\SubscriptionConsumerRemoveConsumerTagOnUnsubscribeSpec' => $vendorDir . '/queue-interop/queue-spec/src/Amqp/SubscriptionConsumerRemoveConsumerTagOnUnsubscribeSpec.php',
    'Interop\\Queue\\Spec\\ConnectionFactorySpec' => $vendorDir . '/queue-interop/queue-spec/src/ConnectionFactorySpec.php',
    'Interop\\Queue\\Spec\\ContextSpec' => $vendorDir . '/queue-interop/queue-spec/src/ContextSpec.php',
    'Interop\\Queue\\Spec\\MessageSpec' => $vendorDir . '/queue-interop/queue-spec/src/MessageSpec.php',
    'Interop\\Queue\\Spec\\ProducerSpec' => $vendorDir . '/queue-interop/queue-spec/src/ProducerSpec.php',
    'Interop\\Queue\\Spec\\QueueSpec' => $vendorDir . '/queue-interop/queue-spec/src/QueueSpec.php',
    'Interop\\Queue\\Spec\\RequeueMessageSpec' => $vendorDir . '/queue-interop/queue-spec/src/RequeueMessageSpec.php',
    'Interop\\Queue\\Spec\\SendAndReceiveDelayedMessageFromQueueSpec' => $vendorDir . '/queue-interop/queue-spec/src/SendAndReceiveDelayedMessageFromQueueSpec.php',
    'Interop\\Queue\\Spec\\SendAndReceivePriorityMessagesFromQueueSpec' => $vendorDir . '/queue-interop/queue-spec/src/SendAndReceivePriorityMessagesFromQueueSpec.php',
    'Interop\\Queue\\Spec\\SendAndReceiveTimeToLiveMessagesFromQueueSpec' => $vendorDir . '/queue-interop/queue-spec/src/SendAndReceiveTimeToLiveMessagesFromQueueSpec.php',
    'Interop\\Queue\\Spec\\SendToAndReceiveFromQueueSpec' => $vendorDir . '/queue-interop/queue-spec/src/SendToAndReceiveFromQueueSpec.php',
    'Interop\\Queue\\Spec\\SendToAndReceiveFromTopicSpec' => $vendorDir . '/queue-interop/queue-spec/src/SendToAndReceiveFromTopicSpec.php',
    'Interop\\Queue\\Spec\\SendToAndReceiveNoWaitFromQueueSpec' => $vendorDir . '/queue-interop/queue-spec/src/SendToAndReceiveNoWaitFromQueueSpec.php',
    'Interop\\Queue\\Spec\\SendToAndReceiveNoWaitFromTopicSpec' => $vendorDir . '/queue-interop/queue-spec/src/SendToAndReceiveNoWaitFromTopicSpec.php',
    'Interop\\Queue\\Spec\\SendToTopicAndReceiveFromQueueSpec' => $vendorDir . '/queue-interop/queue-spec/src/SendToTopicAndReceiveFromQueueSpec.php',
    'Interop\\Queue\\Spec\\SendToTopicAndReceiveNoWaitFromQueueSpec' => $vendorDir . '/queue-interop/queue-spec/src/SendToTopicAndReceiveNoWaitFromQueueSpec.php',
    'Interop\\Queue\\Spec\\SubscriptionConsumerConsumeFromAllSubscribedQueuesSpec' => $vendorDir . '/queue-interop/queue-spec/src/SubscriptionConsumerConsumeFromAllSubscribedQueuesSpec.php',
    'Interop\\Queue\\Spec\\SubscriptionConsumerConsumeUntilUnsubscribedSpec' => $vendorDir . '/queue-interop/queue-spec/src/SubscriptionConsumerConsumeUntilUnsubscribedSpec.php',
    'Interop\\Queue\\Spec\\SubscriptionConsumerStopOnFalseSpec' => $vendorDir . '/queue-interop/queue-spec/src/SubscriptionConsumerStopOnFalseSpec.php',
    'Interop\\Queue\\Spec\\TopicSpec' => $vendorDir . '/queue-interop/queue-spec/src/TopicSpec.php',
